...
Dobre, ale trosku mlhave. Napis tady, ze ta metoda dela pri kompresi dva passy. A pak nejak jasne sdel, ze dekomprese dela jen ten top-down a jak se lisi od toho kompresniho top-down.
...
\subsecwithtoc{LZ77 compression}\label{subsec:lz77}
...
\subsecwithtoc{Huffman coding}\label{subsec:huffman}
